        ...
        <div className="pixel-border p-6 mb-8 bg-zinc-800">
          ...
          <Tabs defaultValue="collected" className="w-full">
            ...
            <TabsContent value="collected">
              {userCollection.length === 0 ? (
                <div className="text-center py-12">
                  <h3 className="text-xl text-blue-400 mb-4">No items in your collection yet</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {userCollection.map((item) => (
                    <Card key={item.id} className="pixel-card bg-zinc-800 border-blue-500 overflow-hidden">
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-sm text-blue-400">{item.rarity}</p>
                          </div>
                        </div>
                      </CardContent>
                      <CardFooter className="p-4 pt-0 flex gap-2">
                        <Button className="w-full pixel-button bg-blue-600 hover:bg-blue-700">Transfer</Button>
            ...
            <TabsContent value="created">
              <div className="text-center py-12">
                <h3 className="text-xl text-blue-400 mb-4">You haven't created any NFTs yet</h3>
                <p className="text-zinc-400 mb-6">Start creating your own magical items</p>
                <Button className="pixel-button bg-blue-600 hover:bg-blue-700">Create NFT</Button>
              </div>
            </TabsContent>

            <TabsContent value="favorited">
              <div className="text-center py-12">
                <h3 className="text-xl text-blue-400 mb-4">No favorited items yet</h3>
